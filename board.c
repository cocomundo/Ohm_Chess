...
int mate(bool color_to_move)
{
    /* 1 == no checkmate*/
    int checkmate = 1;
    int eval = move_gen(board, 2, INT_MIN, INT_MAX, color_to_move, false, false, false, false, false, NULL, 0);
    ...
    /* stalemate */
    if(checkmate != 1){
        eval = move_gen(board, 1, INT_MIN, INT_MAX, !color_to_move, false, false, false, false, false, NULL, 0);
